...
//        configuration.applicationId = @"DXsvTSLgsKT03gSSqy6V5KbLwVpgfEjmEsKzzQUP";
//        configuration.clie = @"BXAzmCJhMtIVWhLVEiKIMzPCA5XI0Nt9NwvAOPVd";
//    
//
//    }]];
    ...
    LoginViewController *businessVC =[[LoginViewController alloc]init];
